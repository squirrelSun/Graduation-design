...
<body>
	...
	<div class="container">
		...
		<form action="merchant/do/login.html" method="post" class="form-signin"
			role="form">
			<h2 class="form-signin-heading">
				<i class="glyphicon glyphicon-log-in"></i> 商户登录
			</h2>
			...
			<div class="form-group has-success has-feedback">
				<input type="text" name="usePswd" class="form-control"
					id="inputSuccess4" placeholder="请输入登录密码" style="margin-top: 10px;">
				<span class="glyphicon glyphicon-lock form-control-feedback"></span>
			</div>
			<button type="submit" class="btn btn-lg btn-success btn-block">登录</button>
			<a href="/print02-webui/to/merchant/register/page.html"
				class="btn btn-lg btn-success btn-block"> 注册 </a>
		</form>
	</div>
</body>
</html>